...
public class System_TypeWrap
{
	...
	static int GetType(IntPtr L)
	{
		try
		{
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(System.Func<System.Reflection.AssemblyName,System.Reflection.Assembly>), typeof(System.Func<System.Reflection.Assembly,string,bool,System.Type>)))
			{
				string arg0 = ToLua.ToString(L, 1);
				System.Func<System.Reflection.AssemblyName,System.Reflection.Assembly> arg1 = null;
				LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

				if (funcType2 != LuaTypes.LUA_TFUNCTION)
				{
					 arg1 = (System.Func<System.Reflection.AssemblyName,System.Reflection.Assembly>)ToLua.ToObject(L, 2);
				}
				else
				{
					LuaFunction func = ToLua.ToLuaFunction(L, 2);
					arg1 = DelegateFactory.CreateDelegate(typeof(System.Func<System.Reflection.AssemblyName,System.Reflection.Assembly>), func) as System.Func<System.Reflection.AssemblyName,System.Reflection.Assembly>;
				}

				System.Func<System.Reflection.Assembly,string,bool,System.Type> arg2 = null;
				LuaTypes funcType3 = LuaDLL.lua_type(L, 3);

				if (funcType3 != LuaTypes.LUA_TFUNCTION)
				{
					 arg2 = (System.Func<System.Reflection.Assembly,string,bool,System.Type>)ToLua.ToObject(L, 3);
				}
				else
				{
					LuaFunction func = ToLua.ToLuaFunction(L, 3);
					arg2 = DelegateFactory.CreateDelegate(typeof(System.Func<System.Reflection.Assembly,string,bool,System.Type>), func) as System.Func<System.Reflection.Assembly,string,bool,System.Type>;
				}
			...
			else if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(System.Func<System.Reflection.AssemblyName,System.Reflection.Assembly>), typeof(System.Func<System.Reflection.Assembly,string,bool,System.Type>), typeof(bool)))
			{
				string arg0 = ToLua.ToString(L, 1);
				System.Func<System.Reflection.AssemblyName,System.Reflection.Assembly> arg1 = null;
				LuaTypes funcType2 = LuaDLL.lua_type(L, 2);
			...
			else if (count == 5 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(System.Func<System.Reflection.AssemblyName,System.Reflection.Assembly>), typeof(System.Func<System.Reflection.Assembly,string,bool,System.Type>), typeof(bool), typeof(bool)))
			{
				string arg0 = ToLua.ToString(L, 1);
				System.Func<System.Reflection.AssemblyName,System.Reflection.Assembly> arg1 = null;
				LuaTypes funcType2 = LuaDLL.lua_type(L, 2);
	...
	static int get_IsConstructedGenericType(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index IsConstructedGenericType on a nil value" : e.Message);
		}
	}
	...
	static int get_GenericTypeArguments(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index GenericTypeArguments on a nil value" : e.Message);
		}
	}
	...
	static int get_IsSecurityCritical(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index IsSecurityCritical on a nil value" : e.Message);
		}
	}
	...
	static int get_IsSecuritySafeCritical(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index IsSecuritySafeCritical on a nil value" : e.Message);
		}
	}
	...
	static int get_IsSecurityTransparent(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index IsSecurityTransparent on a nil value" : e.Message);
		}
	}
