...
public class System_StringWrap
{
	...
	static int Join(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(System.Collections.Generic.IEnumerable<string>)))
			{
			...
			else if (TypeChecker.CheckTypes(L, 1, typeof(string)) && TypeChecker.CheckParamsType(L, typeof(string), 2, count - 1))
			{
				string arg0 = ToLua.ToString(L, 1);
	...
	static int Split(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(char[]), typeof(int)))
			{
				System.String obj = (System.String)ToLua.ToObject(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(char[]), typeof(System.StringSplitOptions)))
			{
				System.String obj = (System.String)ToLua.ToObject(L, 1);
				char[] arg0 = ToLua.CheckCharBuffer(L, 2);
	...
	static int Replace(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(char), typeof(char)))
			{
				System.String obj = (System.String)ToLua.ToObject(L, 1);
				char arg0 = (char)LuaDLL.lua_tonumber(L, 2);
				char arg1 = (char)LuaDLL.lua_tonumber(L, 3);
	...
	static int Format(IntPtr L)
	{
		try
		{
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(System.IFormatProvider), typeof(string), typeof(object)))
			{
			...
			else if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(System.IFormatProvider), typeof(string), typeof(object), typeof(object)))
			{
				System.IFormatProvider arg0 = (System.IFormatProvider)ToLua.ToObject(L, 1);
				string arg1 = ToLua.ToString(L, 2);
				object arg2 = ToLua.ToVarObject(L, 3);
			...
			else if (count == 5 && TypeChecker.CheckTypes(L, 1, typeof(System.IFormatProvider), typeof(string), typeof(object), typeof(object), typeof(object)))
			{
				System.IFormatProvider arg0 = (System.IFormatProvider)ToLua.ToObject(L, 1);
				string arg1 = ToLua.ToString(L, 2);
				object arg2 = ToLua.ToVarObject(L, 3);
	...
	static int Concat(IntPtr L)
	{
		try
		{
			...
			if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(System.Collections.Generic.IEnumerable<string>)))
			{
